# Robust Trajectory Tracking of a 3-DOF Robotic Thumb via Disturbance-Observer-Augmented Model-Based Sliding-Mode Control — Complete Documentation
...
A 3-DOF robotic thumb is a nonlinear, multi-body system. As the thumb
...
a compact robotic thumb platform.
...
A 3-DOF robotic thumb closes a grip, holds it, and rejects a
...
- Peak torques: q1 = 21.4 mN·m, q2 = 12.2 mN·m, q3 = 1.74 mN·m. These are within
  realistic micro-actuator output for a compact robotic thumb platform.
...
| `thumb_kinematics.m` | Standard DH table, $A_i$, $T_0^i$, full $T_0^3$, and joint positions | Standalone FK check |
...
| `thumb_dh_forward_kinematics.png` | documentation asset | 1200×627 DH table, kinematic chain, full transform, and numeric fingertip pose |
| `thumb_linkedin_beforeafter.png` | documentation asset | 1200×627 side-by-side SMC q2 failure vs NDOB recovery comparison |
| `thumb_linkedin_infographic.png` | documentation asset | 1200×1700 MATLAB-generated academic infographic with plant, DH, control law, observer, plots, and result table |
...
### Presentation figures included in the repository

Three presentation-ready figures are included alongside the simulation outputs. They do not introduce new numerical claims; they compress the existing results and kinematic context into publication- and portfolio-friendly formats.

- [`thumb_dh_forward_kinematics.png`](thumb_dh_forward_kinematics.png) is a 1200×627 DH/FK figure. The flow is geometry → DH table → $A_i$ matrices → $T_0^3$ → fingertip pose.
- [`thumb_linkedin_beforeafter.png`](thumb_linkedin_beforeafter.png) is a 1200×627 side-by-side comparison. The left half shows the stressed SMC-MB q2 tracking collapse; the right half shows NDOB+SMC under the identical disturbance.
- [`thumb_linkedin_infographic.png`](thumb_linkedin_infographic.png) is a 1200×1700 MATLAB infographic. It combines plant parameters, DH parameters, the Euler-Lagrange plant, SMC law, NDOB law, measured q2 error, observer estimate, log-scale RMS comparison, and the quantitative results table.
